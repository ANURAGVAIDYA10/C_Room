...
import ToastWithProgressBar from "../ui/toast/ToastWithProgressBar";
...
export default function SignInForm() {
  ...
  useEffect(() => {
    if (shouldNavigate && !authLoading && currentUser) {
      ...
      // Hide the success toast after navigation
  ...
  useEffect(() => {
    if (showSuccessToast) {
      ...
      // Clear the timer if the component unmounts or toast is closed manually
    ...
    <>
            ...
            <div>
              ...
              <form onSubmit={handleSubmitForm}>
                <div className="space-y-6">
                  ...
                  <div>
                    <button type="submit" className="w-full py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center" disabled={loading}>
                      {loading ? (
                        <>
      ...
      {showSuccessToast && (
        <ToastWithProgressBar 
          message="Welcome! You have successfully signed in to your account." 
