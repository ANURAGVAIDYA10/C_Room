...
const alertConfigs: Record<AlertType, AlertConfig> = {
  success: {
    backgroundClass: "bg-success-500",
    hoverClass: "hover:bg-success-600",
    iconBackgroundClass: "fill-success-50 dark:fill-success-500/15",
    iconFillClass: "fill-success-600 dark:fill-success-500",
    title: "Well Done!",
    ...
    buttonHoverClass: "hover:bg-success-600",
  ...
  info: {
    backgroundClass: "bg-blue-light-500",
    hoverClass: "hover:bg-blue-light-600",
    iconBackgroundClass: "fill-blue-light-50 dark:fill-blue-light-500/15",
    iconFillClass: "fill-blue-light-500 dark:fill-blue-light-500",
    title: "Information Alert!",
    message: "Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non. Quisque eu ut tempor curabitur.",
    buttonText: "Okay, Got It",
    buttonClass: "bg-blue-light-500",
    buttonHoverClass: "hover:bg-blue-light-600",
  ...
  warning: {
    ...
    iconBackgroundClass: "fill-warning-50 dark:fill-warning-500/15",
    iconFillClass: "fill-warning-600 dark:fill-orange-400",
    title: "Warning Alert!",
    message: "Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non. Quisque eu ut tempor curabitur.",
    buttonText: "Okay, Got It",
    buttonClass: "bg-warning-500",
    buttonHoverClass: "hover:bg-warning-600",
  ...
  error: {
    backgroundClass: "bg-error-500",
    hoverClass: "hover:bg-error-600",
    iconBackgroundClass: "fill-error-50 dark:fill-error-500/15",
    iconFillClass: "fill-error-600 dark:fill-error-500",
    title: "Danger Alert!",
    message: "Lorem ipsum dolor sit amet consectetur. Feugiat ipsum libero tempor felis risus nisi non. Quisque eu ut tempor curabitur.",
    buttonText: "Okay, Got It",
    buttonClass: "bg-error-500",
    buttonHoverClass: "hover:bg-error-600",
...
interface ModalBasedAlertsProps {
  isOpen: boolean;
  onClose: () => void;
  type: AlertType;
  title?: string;
...
const ModalBasedAlerts: React.FC<ModalBasedAlertsProps> = ({
  isOpen,
  onClose,
  type,
  title,
    ...
    <Modal isOpen={isOpen} onClose={onClose} className={className}>
      <div className="text-center">
        <div className="relative flex items-center justify-center z-1 mb-7">
          <svg
            className={config.iconBackgroundClass}
            width="90"
            height="90"
            viewBox="0 0 90 90"
            fill="none"
          ...
          <span className="absolute -translate-x-1/2 -translate-y-1/2 left-1/2 top-1/2">
            <svg
              className={config.iconFillClass}
              width="38"
              height="38"
              viewBox="0 0 38 38"
              fill="none"
        ...
        <div className="flex items-center justify-center w-full gap-3 mt-7">
          <button
            type="button"
            className={`flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg shadow-theme-xs sm:w-auto ${config.buttonClass} ${config.buttonHoverClass}`}
            onClick={onClose}
          >
            {displayButtonText}
          </button>
