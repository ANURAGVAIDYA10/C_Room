    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 xl:border-b">
      <div className="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 lg:py-4">
          ...
          <Link to="/ecommerce/dashboard" className="xl:hidden">
            <img
          ...
          <div className="hidden xl:block">
            <div className="flex items-center gap-3">
              ...
              <PrimaryButton
                size="sm"
                onClick={() => window.dispatchEvent(new CustomEvent('openCreateIssueModal'))}
              >
                <svg
                  className="h-4 w-4"
                  width="18"
                ...
                >
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                    d="M10.494 2.24756C10.494 1.44919 9.84481 0.8 9.04644 0.8C8.24807 0.8 7.59891 1.44919 7.59891 2.24756V7.59891H2.24756C1.44919 7.59891 0.8 8.24807 0.8 9.04644C0.8 9.84481 1.44919 10.494 2.24756 10.494H7.59891V15.8453C7.59891 16.6437 8.24807 17.2929 9.04644 17.2929C9.84481 17.2929 10.494 16.6437 10.494 15.8453V10.494H15.8453C16.6437 10.494 17.2929 9.84481 17.2929 9.04644C17.2929 8.24807 16.6437 7.59891 15.8453 7.59891H10.494V2.24756Z"
                    fill="currentColor"
                  ></path>
                </svg>
                Create Request
