...
// import 'react-datepicker/dist/react-datepicker.css'; // Commented out since not installed
// Import useAuth hook to access user details
import { useAuth } from "../../context/AuthContext";
import { jiraService } from '../../services/jiraService';
import { userApi } from '../../services/api';
import Button from "../../components/ui/button/Button";
import PrimaryButtonWithLeftIcon from "../../components/ui/button/PrimaryButtonWithLeftIcon";
...
const VendorAgreements: React.FC = () => {
  ...
  return (
    <div className="p-6">
      {/* Show toast if needed - SuccessToast2 component not available */}
